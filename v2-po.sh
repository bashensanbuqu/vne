...
installV2Ray(){
    ...
    if [[ ! -f "/etc/v2ray/config.json" ]]; then
        ...
        colorEcho ${BLUE} "Downloading ProxyPanel v2ray config."
        DOWNLOAD_LINK="https://github.com/ColetteContreras/v2ray-poseidon/wiki/v2ray-poseidon-proxypanel/config.json"
